title: "Quickstart"
description: "Get your Discord bot hosted with Cybrance.nl in minutes"

---

## Quickstart Guide

Follow these steps to launch your Discord bot on Cybrance.nl:
...
### Step 2: Deploy to Cybrance.nl

<AccordionGroup>
  <Accordion icon="cloud-arrow-up" title="Connect your GitHub repository">
    Link your GitHub account and select your bot repository in the [Cybrance
    Dashboard](https://cybrance.nl/dashboard).
  </Accordion>
...
<Note>
  Need help? Join our [Discord Community](https://discord.gg/cybrance) or email
  [support@cybrance.nl](mailto:support@cybrance.nl).
</Note>
